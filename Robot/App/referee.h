...
uint8_t get_shooter_speed_limit(void);
uint8_t get_front_amour_attacked(void);
uint8_t get_right_amour_attacked(void);
uint8_t get_back_amour_attacked(void);
uint8_t get_left_amour_attacked(void);
#endif
